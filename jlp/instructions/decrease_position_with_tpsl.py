...
class DecreasePositionWithTpslArgs(typing.TypedDict):
    params: types.decrease_position_with_tpsl_params.DecreasePositionWithTpslParams


layout = borsh.CStruct(
    "params"
    / types.decrease_position_with_tpsl_params.DecreasePositionWithTpslParams.layout
)


class DecreasePositionWithTpslAccounts(typing.TypedDict):
    keeper: Pubkey
    owner: Pubkey
...
def decrease_position_with_tpsl(
    args: DecreasePositionWithTpslArgs,
    accounts: DecreasePositionWithTpslAccounts,
    ...
    identifier = b"l\x12\xcb\xd1\xe3gA\xa5"

...
class GetRemoveLiquidityAmountAndFeeArgs(typing.TypedDict):
    params: types.get_remove_liquidity_amount_and_fee_params.GetRemoveLiquidityAmountAndFeeParams


layout = borsh.CStruct(
    "params"
    / types.get_remove_liquidity_amount_and_fee_params.GetRemoveLiquidityAmountAndFeeParams.layout
)


class GetRemoveLiquidityAmountAndFeeAccounts(typing.TypedDict):
    perpetuals: Pubkey
    pool: Pubkey
    custody: Pubkey
...
def get_remove_liquidity_amount_and_fee(
    ...
    identifier = b"\xc2\xe2\xe9f\x0e\x15\xc4\x07"

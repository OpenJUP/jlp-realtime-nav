...
class AddLiquidity2Args(typing.TypedDict):
    params: types.add_liquidity2_params.AddLiquidity2Params


layout = borsh.CStruct(
    "params" / types.add_liquidity2_params.AddLiquidity2Params.layout
)


class AddLiquidity2Accounts(typing.TypedDict):
    owner: Pubkey
...
def add_liquidity2(
    ...
    identifier = b"\xe4\xa2N\x1cF\xdbts"

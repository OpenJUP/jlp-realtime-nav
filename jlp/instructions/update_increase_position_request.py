...
class UpdateIncreasePositionRequestArgs(typing.TypedDict):
    params: types.update_increase_position_request_params.UpdateIncreasePositionRequestParams


layout = borsh.CStruct(
    "params"
    / types.update_increase_position_request_params.UpdateIncreasePositionRequestParams.layout
)


class UpdateIncreasePositionRequestAccounts(typing.TypedDict):
    owner: Pubkey
    perpetuals: Pubkey
    pool: Pubkey
    position: Pubkey
...
def update_increase_position_request(

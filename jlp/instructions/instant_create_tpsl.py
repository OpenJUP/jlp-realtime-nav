...
class InstantCreateTpslArgs(typing.TypedDict):
    params: types.instant_create_tpsl_params.InstantCreateTpslParams


layout = borsh.CStruct(
    "params" / types.instant_create_tpsl_params.InstantCreateTpslParams.layout
)


class InstantCreateTpslAccounts(typing.TypedDict):
    keeper: Pubkey
    api_keeper: Pubkey
    owner: Pubkey
...
def instant_create_tpsl(
    args: InstantCreateTpslArgs,
    ...
    identifier = b"ubB\x7f\x1e2I\xb9"

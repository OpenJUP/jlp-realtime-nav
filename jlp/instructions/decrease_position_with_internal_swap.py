...
class DecreasePositionWithInternalSwapArgs(typing.TypedDict):
    params: (
        types.decrease_position_with_internal_swap_params.DecreasePositionWithInternalSwapParams
    )


layout = borsh.CStruct(
    "params"
    / types.decrease_position_with_internal_swap_params.DecreasePositionWithInternalSwapParams.layout
)


class DecreasePositionWithInternalSwapAccounts(typing.TypedDict):
    keeper: Pubkey
    owner: Pubkey
...
def decrease_position_with_internal_swap(
    args: DecreasePositionWithInternalSwapArgs,

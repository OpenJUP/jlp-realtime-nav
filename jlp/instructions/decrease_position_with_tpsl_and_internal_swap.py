...
class DecreasePositionWithTpslAndInternalSwapArgs(typing.TypedDict):
    params: (
        types.decrease_position_with_tpsl_and_internal_swap_params.DecreasePositionWithTpslAndInternalSwapParams
    )


layout = borsh.CStruct(
    "params"
    / types.decrease_position_with_tpsl_and_internal_swap_params.DecreasePositionWithTpslAndInternalSwapParams.layout
)


class DecreasePositionWithTpslAndInternalSwapAccounts(typing.TypedDict):
    keeper: Pubkey
    owner: Pubkey
...
def decrease_position_with_tpsl_and_internal_swap(
    args: DecreasePositionWithTpslAndInternalSwapArgs,
    accounts: DecreasePositionWithTpslAndInternalSwapAccounts,
    ...
    identifier = b"\x02o\xc8\xe7#A{\xeb"

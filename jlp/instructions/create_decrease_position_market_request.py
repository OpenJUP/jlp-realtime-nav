...
class CreateDecreasePositionMarketRequestArgs(typing.TypedDict):
    params: (
        types.create_decrease_position_market_request_params.CreateDecreasePositionMarketRequestParams
    )


layout = borsh.CStruct(
    "params"
    / types.create_decrease_position_market_request_params.CreateDecreasePositionMarketRequestParams.layout
)


class CreateDecreasePositionMarketRequestAccounts(typing.TypedDict):
    owner: Pubkey
...
def create_decrease_position_market_request(
    args: CreateDecreasePositionMarketRequestArgs,
    ...
    identifier = b"J\xc6\xc3V\xc1c\x01O"

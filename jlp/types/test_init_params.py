...
class TestInitParamsJSON(typing.TypedDict):
    allow_swap: bool
...
class TestInitParams:
    ...
    @classmethod
    def from_decoded(cls, obj: Container) -> "TestInitParams":
        return cls(
    ...
    def to_json(self) -> TestInitParamsJSON:
        return {
            "allow_swap": self.allow_swap,
            "allow_add_liquidity": self.allow_add_liquidity,
            "allow_remove_liquidity": self.allow_remove_liquidity,
    ...
    @classmethod
    def from_json(cls, obj: TestInitParamsJSON) -> "TestInitParams":
        return cls(
            allow_swap=obj["allow_swap"],
            allow_add_liquidity=obj["allow_add_liquidity"],
            allow_remove_liquidity=obj["allow_remove_liquidity"],
